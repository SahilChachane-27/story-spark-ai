...
const NavListComponent = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-400/70 bg-slate-100/95 shadow-[0_8px_28px_rgba(15,23,42,0.14)] backdrop-blur-md dark:border-white/10 dark:bg-[#0B1120]/80 dark:shadow-none">
